package com.privatebrowser.safebrowser.download.video.videos.service;
...
import com.privatebrowser.safebrowser.download.video.videos.player.PlayerManager;
...
public class VideoService extends Service implements AudioManager.OnAudioFocusChangeListener {
    ...
    public void onCreate() {
        ...
        Log.e("size", "onCreate: " + mGlobalVar.videoItemsPlaylist.size());
    ...
    public void initExoPlayer() {
        ...
        playerManager.getSimpleExoPlayer().addListener(new Player.Listener() {
            @Override
            public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
                Log.e("size", "onPlayerStateChanged: " + mGlobalVar.videoItemsPlaylist.size());
            ...
            public void onPlayerError(PlaybackException error) {
                Log.e("ZZ", error.getCause().toString());
    ...
    private Notification buildNotification() {
        ...
        Intent nowPlayingIntent = new Intent(this, BrowserMainActivity.class);
        ...
        if (videoItem.getPath() != null) {
            content = videoItem.getPath();
            name = videoItem.getName();
        }

        androidx.core.app.NotificationCompat.Builder
                builder = new androidx.core.app.NotificationCompat.Builder(this, NOTIFICATIONCHANNELID)
    ...
    private void loadImage(VideoModel videoItem) {
        Glide.with(this).asBitmap()
                .load(videoItem.getPath() != null ? videoItem.getPath() : " ")
