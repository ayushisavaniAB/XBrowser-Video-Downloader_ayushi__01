...
//        SharedPreferences prefs = context.getSharedPreferences("settings", 0);
        data.easyListLastModified = prefernces.getString(context.getString(R.string.easyListLastModified), "");
    }
...
//        SharedPreferences prefs = context.getSharedPreferences("settings", 0);
        prefernces.putString(context.getString(R.string.easyListLastModified), data.easyListLastModified);
    }
